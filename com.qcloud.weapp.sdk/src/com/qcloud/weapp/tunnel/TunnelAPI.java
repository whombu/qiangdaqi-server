...
//		System.out.println("get wsurl:" + result.toString());
	...
	public EmitResult emitPacket(String[] tunnelIds, String packetType, JSONObject packetContent) throws EmitError {
		...
		try {
			...
			JSONArray invalidTunnelIds = emitReturn != null && emitReturn.has("invalidTunnelIds")
					? emitReturn.getJSONArray("invalidTunnelIds") : new JSONArray();
